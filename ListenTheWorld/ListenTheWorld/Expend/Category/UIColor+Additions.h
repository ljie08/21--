...
/**
 ...
  * @param 红色0-255范围内的红色值。
  * @param 绿色0-255范围内的绿色价值。
  * @param 蓝0-255范围内的蓝色值。
  * @return 从RGB值的新颜色。
  **/
...
/**
  * 创建一个新的颜色变浅。
  * @param 值浮点值从0到1，其中0表示没有变化，1表示最亮可能的颜色。
  * @return 一个新的颜色。
  **/
...
/**
  * 创建一个新的更暗的颜色。
  * @param 值浮动值从0到1，其中0表示没有变化，1是指最黑暗的可能的颜色。
  * @return 一个新的颜色。
  **/
